...
const SESSION_KEY = 'erp_v56_session'
const CACHE_KEY = 'erp_v56_client_cache'
const DRAFT_PREFIX = 'erp_v56_draft_v1'
const LOCAL_SAVE_PREFIX = 'erp_v56_local_first_v1'
const PRELOAD_PREFIX = 'erp_v56_today_preload_v1'
const LAST_DEPT_KEY = 'erp_v56_last_department'
const BOOT_KEY = 'erp_v56_boot_init_v1'
const PRELOAD_TTL_MS = 6 * 60 * 60 * 1000
const SMART_REFRESH_MS = 60 * 1000
const ERP_CLIENT_VERSION = 'V30.56_BASELINE_RESTORE_STAFF_LOGIN'
