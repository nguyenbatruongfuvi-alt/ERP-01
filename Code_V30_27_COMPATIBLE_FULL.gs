...
function exportTangCaExcel(filter) {
  ...
  const name = 'TangCa_' + safeBp + '_' + safeRange + '_' + stamp;
  ...
  values.push(['Bộ phận', boPhan, 'Từ ngày', tuNgay, 'Đến ngày', denNgay, 'Tháng', thang].concat(Array(Math.max(colCount - 8, 0)).fill('')).slice(0, colCount));
  values.push(headers);
